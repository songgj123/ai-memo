...
interface MemoItemProps {
  ...
  onViewDetail: (memo: Memo) => void
}

export default function MemoItem({ memo, onEdit, onDelete, onViewDetail }: MemoItemProps) {
  ...
  return (
    ...
    >
      ...
      {/* 내용 */}
      <div className="mb-4">
        <div data-color-mode="light" className="line-clamp-3 text-sm overflow-hidden">
          <MarkdownPreview 
            source={memo.content} 
            style={{ 
              padding: 0,
